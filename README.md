...
```bash
go install github.com/asachs01/smtp-edc/cmd/smtp-edc@latest
```
...
cd smtp-edc
go build -tags cli -o smtp-edc cmd/smtp-edc/main.go  # CLI version
```
...
- [Comprehensive README](docs/COMPREHENSIVE_README.md) - Detailed project documentation
- [Troubleshooting Guide](docs/TROUBLESHOOTING_GUIDE.md) - Common issues and solutions
- [Wails UI Conversion Plan](docs/WAILS_UI_CONVERSION_PLAN.md) - Desktop app development plan
- [Product Requirements Document](docs/WAILS_UI_PRD.md) - Detailed requirements specification
